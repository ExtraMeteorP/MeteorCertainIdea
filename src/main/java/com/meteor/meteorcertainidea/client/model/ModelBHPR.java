...
public class ModelBHPR<T extends Entity> extends EntityModel<T>{

    private final ModelPart bone;
    private final ModelPart bone2;

    public ModelBHPR(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -9.0F, -8.0F, 16.0F, 6.0F, 16.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 22).addBox(-8.0F, -15.0F, -8.0F, 4.0F, 6.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
        ...
        PartDefinition bone3 = bone.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -39.0F, 6.0F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 50).addBox(-4.0F, -11.0F, 6.0F, 12.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition bone2 = partdefinition.addOrReplaceChild("bone2", CubeListBuilder.create(), PartPose.offset(0.0F, -4.0F, 14.0F));

        PartDefinition cube_r1 = bone2.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(40, 22).addBox(-13.0F, -20.0F, -13.0F, 14.0F, 20.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-7.0F, 2.0F, 6.0F, 0.0F, 0.0F, -0.3491F));
